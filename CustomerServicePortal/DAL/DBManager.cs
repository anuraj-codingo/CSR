...
namespace CustomerServicePortal.DAL
{
    public class DBManager
    {
        ...
        {
            dbFactory = new DatabaseHandlerFactory(connection);
        ...
        public IDataReader GetDataReader(string commandText, CommandType commandType, IDbDataParameter[] parameters = null)
        {
